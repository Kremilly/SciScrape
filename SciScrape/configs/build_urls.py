...
class BuildUrls:
    ...
    @classmethod
    def api_search(cls, search_term: str, max_results: int) -> str:
    ...
    @classmethod
    def author_page_link(cls, author_name: str) -> str:
